...
Project created using `Vue.Web.Starter` template. Only changes default port from `8000` to `8010`.
...
The [GitHub repo for this template is here](https://github.com/robconery/HealthEventTrackerApp). I don't have discussions enabled, but feel free to pop an issue if you like or, better yet, a PR!
